...
class CameraModel(UtilsData):
    ...
    image = models.ImageField(upload_to='cameras/images/', blank=True, null=True, verbose_name="Imagen")
...
class CameraConfiguration(UtilsData):
    ...
    camera_model = models.OneToOneField(CameraModel, on_delete=models.CASCADE,related_name='configuration', verbose_name="Modelo de Cámara")
    # Video
    max_resolution = models.CharField(max_length=20, choices=RESOLUTION_CHOICES, verbose_name="Resolución Máxima")
    custom_resolution = models.CharField(max_length=50, blank=True, verbose_name="Resolución Personalizada")
    compression = models.CharField(max_length=20, choices=COMPRESSION_CHOICES, default='h265', verbose_name="Compresión")
    ...
    protocol = models.CharField(max_length=10, choices=PROTOCOL_CHOICES, default='rtsp', verbose_name="Protocolo Principal")
    ...
    # Óptica
    focal_length_min = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Focal Mín (mm)")
    focal_length_max = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Focal Máx (mm)")
    horizontal_fov = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="FOV Horizontal (°)")
    ...
    # Características
    night_mode = models.CharField(max_length=20, choices=NIGHT_MODE_CHOICES, default='ir', verbose_name="Modo Nocturno")
    ...
    # Alimentación
    power_consumption_watts = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True, verbose_name="Consumo (W)")
    poe_class = models.CharField(max_length=20, blank=True, verbose_name="Clase PoE")

    # Ambiente
    ip_rating = models.CharField(max_length=10, default='IP67', verbose_name="Clasificación IP")
    ik_rating = models.CharField(max_length=10, blank=True, verbose_name="Clasificación IK")
    ...
    # RTSP URL pattern
    rtsp_main_stream = models.CharField(max_length=300,default='rtsp://{user}:{password}@{ip}:{port}/Streaming/Channels/101',verbose_name="RTSP Stream Principal")
    rtsp_sub_stream = models.CharField(max_length=300,blank=True,default='rtsp://{user}:{password}@{ip}:{port}/Streaming/Channels/102',verbose_name="RTSP Sub-Stream")

    # Credenciales por defecto
    default_username = models.CharField(max_length=100, default='admin', verbose_name="Usuario por Defecto")
    default_password = models.CharField(max_length=100, default='admin12345', verbose_name="Contraseña por Defecto")
...
class Storage(UtilsData):
    camera_slot = models.ForeignKey(CameraModel,on_delete=models.CASCADE,related_name="camara_que_guarda",verbose_name="Camara que guarda")
    sd_card_slot = models.BooleanField(default=True, verbose_name="Ranura SD")
    max_sd_capacity_gb = models.PositiveIntegerField(default=256, blank=True, null=True, verbose_name="Capacidad SD Máx (GB)")
